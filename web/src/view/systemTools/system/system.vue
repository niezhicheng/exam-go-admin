      ...
      <el-tabs v-model="activeNames">
        ...
        >
          ...
          <el-form-item label="多点登录拦截">
            <el-switch v-model="config.system['sysEmStudent-multipoint']"/>
          </el-form-item>
          <el-form-item label="开启redis">
            <el-switch v-model="config.system['sysEmStudent-redis']"/>
          </el-form-item>
          <el-form-item label="开启Mongo">
            <el-switch v-model="config.system['sysEmStudent-mongo']"/>
          </el-form-item>
          <el-form-item label="严格角色模式">
            <el-switch v-model="config.system['sysEmStudent-strict-auth']"/>
          </el-form-item>
        ...
        <el-tab-pane
            ...
            name="4"
            class="mt-3.5"
            v-if="config.system['sysEmStudent-redis']"
        >
        ...
        <el-tab-pane
            ...
            name="14"
            class="mt-3.5"
            v-if="config.system['sysEmStudent-mongo']"
        >
        ...
        >
          ...
          <template v-if="config.system['oss-type'] === 'qiniu'">
            ...
            <el-form-item label="是否使用https">
              <el-switch v-model="config.qiniu['sysEmStudent-https']">开启</el-switch>
            </el-form-item>
            ...
            <el-form-item label="上传是否使用CDN上传加速">
              <el-switch v-model="config.qiniu['sysEmStudent-cdn-domains']" />
            </el-form-item>
          </template>
